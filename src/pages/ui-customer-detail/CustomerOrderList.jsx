...
// const CustomerOrderList = ({ shipperId }) => {
...
//     if (!orders || orders.length === 0) return <p className="text-center text-gray-500">Không có đơn hàng nào.</p>;
...
//             case "processing":
//                 return { text: "Đang xử lý", className: "text-yellow-700 bg-yellow-100 p-1 rounded" };
//             case "pending":
//                 return { text: "Chờ xử lý", className: "text-orange-700 bg-orange-100 p-1 rounded" };
//             case "cancelled":
//                 return { text: "Đã hủy", className: "text-red-700 bg-red-100 p-1 rounded" };
//             default:
//                 return { text: "Không xác định", className: "text-gray-700 bg-gray-100 p-1 rounded" };
//         }
//     };
...
//             case "shipping":
//                 return { text: "Đang giao", className: "text-yellow-700 bg-yellow-100 p-1 rounded" };
...
//             <h2 className="mb-4 text-2xl font-bold text-center text-gray-800">Các đơn hàng của người giao hàng</h2>
...
//                                     </td>
//                                     <td className="p-2 border">
//                                         <span className={shippingStatus.className}>{shippingStatus.text}</span>
//                                     </td>
