...
const UserDetailPage = () => {
    ...
    useEffect(() => {
        ...
        const foundUser = userData.find((user) => user.id === Number.parseInt(id)); // Tìm user theo id
        setUser(foundUser);
    }, [id]);
        ...
        <div className="max-w-lg mx-auto mt-10 p-6 bg-white shadow-md rounded-lg">
            ...
            <div className="flex flex-col items-center">
                ...
                <p className="mt-4">
                    Trạng thái:
                    <span
                        className={`ml-2 px-3 py-1 rounded-full text-white ${user.status ? "bg-green-500" : "bg-red-500"}`}
                    >
